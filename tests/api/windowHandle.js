describe('windowHandle() example test', function () {
  ...
  it('demo test', function (browser) {
    browser.saveScreenshot('screens/api/test/windowHandle1.png');
    browser.saveScreenshot('screens/api/test/windowHandle2.png');
    browser
  ...
  it('demo test async', async function (browser) {
    await browser.saveScreenshot('screens/api/test/windowHandle3.png');
    await browser.saveScreenshot('screens/api/test/windowHandle4.png');
