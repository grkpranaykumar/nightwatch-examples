describe('.clearValue() example test', function () {
  ...
  it('clear value', function (browser) {
    browser
      .saveScreenshot('screens/api/test/clearValue1.png')
      .assert.visible('input[type=search]')
      .setValue('input[type=search]', 'nightwatch')
      .assert.valueEquals('input[type=search]', 'nightwatch')
      .saveScreenshot('screens/api/test/clearValue2.png')
  ...
  it('clear value – using callback argument', function (browser) {
    browser
      .saveScreenshot('screens/api/test/clearValue3.png')
      .setValue('input[type=search]', 'nightwatch')
      .saveScreenshot('screens/api/test/clearValue4.png')
  ...
  it('clear value – with explicit locate strategy', function (browser) {
    browser
      .setValue('input[type=search]', 'nightwatch')
      .saveScreenshot('screens/api/test/clearValue5.png')
      .clearValue('css selector', 'input[type=search]')
      .saveScreenshot('screens/api/test/clearValue6.png')
      .assert.valueEquals('input[type=search]', '');
  });
  ...
  it('clear value – with selector object', function (browser) {
    ...
    browser
      .setValue('input[type=search]', 'nightwatch')
      .saveScreenshot('screens/api/test/clearValue7.png')
      .clearValue({
        selector: 'input[type=search]',
        suppressNotFoundErrors: true
      })
      .saveScreenshot('screens/api/test/clearValue8.png')
      .assert.valueEquals('input[type=search]', '');
  });
});
