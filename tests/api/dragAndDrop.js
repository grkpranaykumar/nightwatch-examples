describe('dragAndDrop() example test', function () {
  ...
  it('demo test', function (browser) {
    browser
      ...
      .saveScreenshot('/Users/pranaykumar/Documents/nightwatch-examples/screens/api/test/dragAndDrop1.png')
      .waitForElementVisible('#src_copy')
      .pause(1000)
      .assert.visible('#dest_copy')
      .saveScreenshot('/Users/pranaykumar/Documents/nightwatch-examples/screens/api/test/dragAndDrop2.png')
