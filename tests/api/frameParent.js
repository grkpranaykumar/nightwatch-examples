describe('frameParent() example test', function () {
  ...
  it('demo test', function (browser) {
    browser
      ...
      .saveScreenshot('/Users/pranaykumar/Documents/nightwatch-examples/screens/api/test/frameParent1.png')
      .assert.elementPresent(frameElement)
      .frame(frameElement, function() {
        console.log(' > Switched to the inner iframe');
      })
      .saveScreenshot('/Users/pranaykumar/Documents/nightwatch-examples/screens/api/test/frameParent2.png')
